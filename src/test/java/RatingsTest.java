...
public class RatingsTest {
    ...
    @Test void testGetMovieRatingsPos(){
        ...
        assertTrue(checkContentsOfArray(tmpRatings, ratings.getMovieRatings(201)), "Not returning correct ratings for movie.");
    }
    ...
    @Test void testGetUserRatingsPos(){
        ...
        assertTrue(checkContentsOfArray(tmpRatings, ratings.getUserRatings(101)), "Not returning correct ratings for user.");
    }
